...
const BLOG = {
  ...
  SINCE: 2021-2023, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'nellycotton', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'nellycotton的博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xm66.eu.org', // 网站地址
